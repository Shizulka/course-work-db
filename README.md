...
Цей бекенд‑додаток для керування бібліотечною системою. Проєкт реалізує бізнес‑логіку роботи з читачами , книгами, примірниками книг, статусами користувачів та сповіщеннями. Основна мета — продемонструвати проєктування реляційної бази даних, роботу з ORM та створення складних SQL‑запитів

Робили:Ліщук Ярина та Оситенко Мирослава ІМ-42.
